...
samp %>% summarise(x_bar = mean(area), sigma = sd(area))
...
49/50 confidence intervals include the true population mean. This is not equal do the confidence level because the confidence level is a lower bound to that proportion.
</div>
